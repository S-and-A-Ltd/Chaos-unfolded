    ...
    (pageIdx: number) =>
      ({ str }: { str: string; itemIndex: number }) => {
            ...
            if (strLower.includes(annotTextLower) || annotTextLower.includes(strLower)) {
              ...
              if (shouldHighlight) {
                ...
                const style = isUnderline
                  ...
                  : `background-color: ${hexToRgba(annot.color, 0.65)}; color: #000 !important; mix-blend-mode: multiply; padding: 0 2px; border-radius: 3px; font-weight: 600;`;
        ...
        if (query && str.toLowerCase().includes(query)) {
          ...
          const style = `background-color: ${hexToRgba(bg, 0.65)}; color: #000 !important; mix-blend-mode: multiply; padding: 0 2px; border-radius: 3px; font-weight: bold; box-shadow: ${shadow};`;
